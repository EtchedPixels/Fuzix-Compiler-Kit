...
OBJS1 = body.o declaration.o enum.o error.o expression.o header.o idxdata.o \
	...
	struct.o switch.o symbol.o tree.o type.o type_iterator.o volatile.o
...
OBJS8 = backend.o backend-8070.o backend-byte.o
OBJS9 = backend.o backend-threadcode.o
OBJS10 = backend.o backend-nova.o
OBJS11 = backend.o backend-6502.o backend-byte.o
