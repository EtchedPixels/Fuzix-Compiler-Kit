...
extern struct node *hier1(LVALUE *lval);
extern struct node *hier1a(LVALUE *lval);
extern struct node *hier1b(LVALUE *lval);
extern struct node *hier1c(LVALUE *lval);
extern struct node *hier2(LVALUE *lval);
extern struct node *hier3(LVALUE *lval);
extern struct node *hier4(LVALUE *lval);
extern struct node *hier5(LVALUE *lval);
extern struct node *hier6(LVALUE *lval);
extern struct node *hier7(LVALUE *lval);
extern struct node *hier8(LVALUE *lval);
extern struct node *hier9(LVALUE *lval);
extern struct node *hier10(LVALUE *lval);
extern struct node *hier11(LVALUE *lval);
...
extern struct node *primary(LVALUE *lval);
...
extern struct node *callfunction(struct symbol *sym, struct node *n);
