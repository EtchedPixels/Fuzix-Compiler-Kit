...
static int pop_help(struct node *n, const char *helper)
{
...
unsigned gen_node(struct node *n)
{
	...
	case T_EQEQ:
		return pop_help(n, "eqeqx");
	case T_GTEQ:
		return pop_help(n, "gtx");
	case T_GT:
		return pop_help(n, "gtx");
	case T_LTEQ:
		return pop_help(n, "lteqx");
	case T_LT:
		return pop_help(n, "ltx");
	case T_BANGEQ:
		return pop_help(n, "nex");
	case T_LTLT:
