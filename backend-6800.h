...
extern void uniop8_on_ptr(const char *op, unsigned off);
extern void uniop16_on_ptr(const char *op, unsigned off);
extern void uniop32_on_ptr(const char *op, unsigned off);
extern void uniop8_on_s(const char *op, unsigned off);
extern void uniop16_on_s(const char *op, unsigned off);
extern void uniop32_on_s(const char *op, unsigned off);
...
extern unsigned uniop8_on_node(struct node *r, const char *op, unsigned off);
extern unsigned uniop16_on_node(struct node *r, const char *op, unsigned off);
...
extern unsigned can_load_x_simple(struct node *r, unsigned off);
extern unsigned can_load_x_with(struct node *r, unsigned off);
